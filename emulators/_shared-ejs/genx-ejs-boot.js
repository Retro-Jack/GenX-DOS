// Shared bootstrap for 9 EmulatorJS bundles: the 6 VICE-family machines,
// ColecoVision, the Atari 2600 (Stella), and the Game Boy / GBC (gambatte).
// (NES/jsnes is also EJS but keeps its own inline boot.)
//
