 ...
 * VirtualT (Tandy TRS-80 Model 100): Emscripten JavaScript glue.
 * Compiled by GenX-DOS from upstream VirtualT plus the headless frontend
 * in systems/m100/src/, by build.sh there (see BUILDING-WASM.md).
 *
...
function findWasmBinary() {
  return locateFile('virtualt.wasm');
}
...
var ASM_CONSTS = {
  ...
  156306: () => window.innerWidth,
  156336: () => window.innerHeight,
};
var _gx_ram_ptr,
  _gx_ram_size,
  _gx_warm_reset,
...
function assignWasmExports(wasmExports) {
  _gx_ram_ptr = Module['_gx_ram_ptr'] = wasmExports['gx_ram_ptr'];
  _gx_ram_size = Module['_gx_ram_size'] = wasmExports['gx_ram_size'];
  _gx_warm_reset = Module['_gx_warm_reset'] = wasmExports['gx_warm_reset'];
