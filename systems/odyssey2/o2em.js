 ...
 * libretro-o2em (Magnavox Odyssey 2): Emscripten JavaScript glue.
 * Compiled by GenX-DOS from github.com/libretro/libretro-o2em with the
 * SDL2 frontend in frontend.c beside it, by systems/odyssey2/build.sh.
 *
...
var createO2EM = (() => {
  ...
  return async function (moduleArg = {}) {
    ...
    var webglGetProgramUniformLocation = (program, location) => {
      if (program) {
        ...
        if (typeof webglLoc == 'number') {
          program.uniformLocsById[location] = webglLoc =
    ...
    var ASM_CONSTS = {
      ...
      255210: () => window.innerWidth,
      255240: () => window.innerHeight,
    };
    var _gx_state_save,
      _gx_state_size,
      _gx_state_buffer,
    ...
    function assignWasmExports(wasmExports) {
      _gx_state_save = Module['_gx_state_save'] = wasmExports['gx_state_save'];
      _gx_state_size = Module['_gx_state_size'] = wasmExports['gx_state_size'];
      _gx_state_buffer = Module['_gx_state_buffer'] =
        wasmExports['gx_state_buffer'];
      _gx_state_load = Module['_gx_state_load'] = wasmExports['gx_state_load'];
...
if (typeof exports === 'object' && typeof module === 'object') {
  module.exports = createO2EM;
  module.exports.default = createO2EM;
