...
GenX-DOS is a browser DOS prompt that boots emulators from numbered menus. We ship 18 emulator engines locally — 32 sub-systems between them — and nothing is fetched at runtime. Every byte lives on the same origin.
