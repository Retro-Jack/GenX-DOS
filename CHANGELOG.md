...
- Drive specs added to both POST and Configuration table: Floppy A `1.44mb (3.5")`, Floppy B `360kb (5.25")`, Hard Disk C `Type 47`, Hard Disk D `Custom`. POST detection lines and table value fields kept aligned (table rows still 80 chars wide).
