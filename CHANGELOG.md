...
### Changed
- Boot screen rebranded from Award POST to authentic AMIBIOS POST, mirroring the AMIBIOS Configuration table specs that follow. Header `AMIBIOS (C) 1985-1991 American Megatrends Inc.,`; CPU `80486SX`, no numeric coprocessor, memory test `8064 KB OK`; floppy A/B and hard disk C/D detection lines all "Not Installed"; canonical `Hit <DEL> if you want to run SETUP` prompt; AMI BIOS ID footer `40-0102-001102-00101111-121291-i486-K8`. Boot helper renamed `renderAwardPost` → `renderAmiBiosPost`.
